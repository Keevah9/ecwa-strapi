...
export interface ApiAllSermonAllSermon extends Schema.CollectionType {
  collectionName: 'all_sermons';
  info: {
...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Slug: Attribute.UID<'api::blog.blog', 'PageTitle'>;
...
export interface ApiGlobalGalleryGlobalGallery extends Schema.SingleType {
  collectionName: 'global_galleries';
  info: {
    singularName: 'global-gallery';
    pluralName: 'global-galleries';
    displayName: 'GlobalGallery';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    galleries: Attribute.Relation<
      'api::global-gallery.global-gallery',
      'oneToMany',
      'api::gallery.gallery'
    >;
    createdAt: Attribute.DateTime;
...
export interface ApiGlobalSermonGlobalSermon extends Schema.SingleType {
  collectionName: 'global_sermons';
  info: {
    singularName: 'global-sermon';
    pluralName: 'global-sermons';
    displayName: 'GlobalSermon';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    pages: Attribute.Relation<
      'api::global-sermon.global-sermon',
      'oneToMany',
      'api::page.page'
    >;
    createdAt: Attribute.DateTime;
...
export interface ApiHomepageHomepage extends Schema.SingleType {
  ...
  attributes: {
    ...
    Sermons: Attribute.Component<'global.sermons'>;
    Contact: Attribute.Component<'global.contact'>;
    TwoColContent: Attribute.Component<'global.two-col-content'>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::all-sermon.all-sermon': ApiAllSermonAllSermon;
      ...
      'api::global-gallery.global-gallery': ApiGlobalGalleryGlobalGallery;
      'api::global-sermon.global-sermon': ApiGlobalSermonGlobalSermon;
